      ...
      <div className="w-full max-w-2xl mb-8">
        <div className="bg-black/30 backdrop-blur-sm rounded-lg p-4 border border-white/10 glass-morphism mb-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <Button variant="outline" className="justify-start text-left glass-morphism hover:bg-gemini-yellow/10 hover:border-gemini-yellow/30 transition-all" onClick={() => sendMessage("Explain quantum computing in simple terms")}>
              <Brain className="h-4 w-4 mr-2 flex-shrink-0 text-gemini-yellow" />
              <span className="truncate">Explain quantum computing</span>
            </Button>
            
            <Button variant="outline" className="justify-start text-left glass-morphism hover:bg-gemini-yellow/10 hover:border-gemini-yellow/30 transition-all" onClick={() => sendMessage("What are the latest breakthroughs in AI?")}>
              <Zap className="h-4 w-4 mr-2 flex-shrink-0 text-gemini-yellow" />
              <span className="truncate">Latest AI breakthroughs</span>
            </Button>
            
            <Button variant="outline" className="justify-start text-left glass-morphism hover:bg-gemini-yellow/10 hover:border-gemini-yellow/30 transition-all" onClick={() => sendMessage("How does climate change affect biodiversity?")}>
              <Globe className="h-4 w-4 mr-2 flex-shrink-0 text-gemini-yellow" />
              <span className="truncate">Climate change effects</span>
            </Button>
            
            <Button variant="outline" className="justify-start text-left glass-morphism hover:bg-gemini-yellow/10 hover:border-gemini-yellow/30 transition-all" onClick={() => sendMessage("Compare renewable vs non-renewable energy")}>
